...
from tensorflow.keras.layers import Conv2DTranspose, Dropout, GlobalAveragePooling2D, Dense, Average, Reshape, Input, Activation
...
def createLayers_(input_x, out):
  # Keras đã hỗ trợ sẵn activation='swish' trực tiếp trong Conv2D
