...
class OCR:
	...
	def __create_model__(self):
		self.opt = SGD(learning_rate=self.__init_lr__)
	...
	def train_model(self):
		...
		mcp_save = ModelCheckpoint('../models/OCR-2U-{epoch:03d}.h5', save_best_only=True, monitor='val_loss', mode='min')
	...
	def plot(self):
		...
		plt.savefig("../models/Result-history.png")
...
if __name__ == '__main__':
	...
	model_path='../models/OCR-2U-024.h5'
